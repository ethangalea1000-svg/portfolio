(() => {
  ...
  const MORE_NEGATIVE = [
    ...
    "méchant","mechant","méchante","mechante","mensonge","menteur","menteuse",
  ...
  const MORE_PHRASES = {
    ...
    "je m'ennuie": -0.95,
    "je m ennuie": -0.95,
    "je m'ennuie beaucoup": -1.20,
    "je m ennuie beaucoup": -1.20,
    "c'est une belle surprise": 1.05,
    "c est une belle surprise": 1.05,
    "quelle surprise": 0.90,
    "quelle surprise !": 1.05,
